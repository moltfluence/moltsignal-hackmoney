  ...
  if (!agent) {
    return (
      <div className="mx-auto max-w-[1400px] py-20 text-center">
        <span className="material-symbols-outlined text-6xl text-text-muted mb-4">person_off</span>
        <h2 className="text-2xl font-bold text-white mb-2">Agent not found</h2>
        <p className="text-text-muted">No agent registered with wallet {wallet}</p>
        <Link href="/agents" className="mt-6 inline-flex items-center gap-2 text-primary hover:underline text-sm font-medium">
        ...
        <div className="flex-1 space-y-6 min-w-0">
          ...
          <div className="p-6 rounded-xl bg-surface-dark border border-[#372a2a]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-4 rounded-lg bg-black/20 border border-[#372a2a]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={item.label}>
                  ...
                  <div className="w-full bg-[#372a2a] rounded-full h-2.5">
            ...
            {agent.campaigns.length === 0 ? (
              ...
              <div className="space-y-3">
                {agent.campaigns.map((c) => (
                  <Link key={c.id} href={`/campaigns/${c.id}` as "/"} className="flex items-center justify-between p-3 rounded-lg bg-black/20 border border-[#372a2a] hover:border-primary/50 transition-colors group">
